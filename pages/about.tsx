        ...
        <CardInner>
          ...
          <div className="text-left">
            <p className="text-md p-5">
                I’m a robotics and computer science graduate passionate about building intelligent systems that see, learn, and navigate the real world. 
                ...
                I am looking for a full-time position that matches my experience while leaving room for my skills to develop over time.
            </p>
      ...
      <CardOuter reverse>
        <CardInner className="flex flex-col justify-center items-center" reverse>
          ...
          <div className="justify-center w-full sm:w-10/12 h-[70vw]">
            <iframe className="justify-center w-full h-[70vw]" src="https://drive.google.com/file/d/1apzI2VIx_VFA83fHaXpGKirzQXAqFNVR/preview">Failed to load resume - download <a href="/resume.pdf" target="_blank">here</a></iframe>
          </div>
        </CardInner>
      </CardOuter>
      <span className="h-10" />
